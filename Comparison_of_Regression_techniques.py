...
plot_predictions(m1_preds, "Linear Regression — Test Predictions")
plot_residuals(m1_preds, "Linear Regression")

# Model 2 — Ridge (with GridSearchCV)
...
plot_predictions(m2_preds, "Ridge — Test Predictions")
plot_residuals(m2_preds, "Ridge")

# Model 3 — Lasso (with GridSearchCV)
...
# Plots: Lasso
plot_predictions(m3_preds, "Lasso — Test Predictions")
...
# 🔹 Reduced grid so training is faster in Colab
param_grid_rf = {
...
# Plots: Random Forest
plot_predictions(m4_preds, "Random Forest — Test Predictions")
...
plot_predictions(m5_preds, "Gradient Boosting — Test Predictions")
...
def show_top_features_fitted(fitted_pipeline, top_k=15, title=""):
    ...
    if hasattr(model, "coef_"):
        ...
        plt.title(title + " — Top coefficients (std. units)")
        plt.tight_layout()
        plt.show()
